...
export default function ShowShippedordersProduct({ route }) {
  ...
  // console.log('productssssssssssssss::', itemData?.cart_product?.[0]?.product)
...
const styles = StyleSheet.create({
  ...
  updated_on: {
    ...
    fontFamily: Fonts.RobotoMedium, marginLeft: 2
  }
})